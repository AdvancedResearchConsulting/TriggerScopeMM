...
public:
   ...
   int StartDASequence();
   int StopDASequence();
   int SendDAOVSequence();
   int SendDAODSequence();
   int SendDASequence();
   int ClearDASequence();
   ...
   int OnPAEnable(MM::PropertyBase* pProp, MM::ActionType eAct);
   int OnODVolts(MM::PropertyBase* pProp, MM::ActionType eAct);
   int OnODDelay(MM::PropertyBase* pProp, MM::ActionType eAct);
   int OnPAStart(MM::PropertyBase* pProp, MM::ActionType eAct);
   int OnPAStop(MM::PropertyBase* pProp, MM::ActionType eAct);
   int OnPAProgram(MM::PropertyBase* pProp, MM::ActionType eAct);

   int PAProgram();
   int ConvertVoltsToDAC(double volts);
...
private:
  ...
  int SendBlankingCommand();
   ...
   int seqCleared_;
	...
	std::vector<double> seqODDelay_;
	std::vector<double> seqODVolts_;
	
	double ODVolts_;
	double ODDelay_;

	MM::PropertyBase* pVoltsProp_;
	MM::PropertyBase* pODDelayProp_;
	MM::PropertyBase* pODVoltsProp_;
};
